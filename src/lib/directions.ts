 ...
 *
 * Reuses the canonical `decodePolyline` implementation in
 * `lib/polyline.ts` (the same one the off-route detector uses)
 * instead of re-implementing the Google polyline algorithm here.
 *
